...
class Ui_MainWindow(object):
    ...
    def all_submit(self):
        ...
        # 决定离职时间
        gn, gy , gr = self.dateEdit_5.date().toString(Qt.ISODate).split('-')
        # 盖章时间
        dqn, dqy, dqr = self.dateEdit_6.date().toString(Qt.ISODate).split('-')
        data = {
            'name': name,
            'uid': uid,
            'rn': rn,
        ...
        document.save(f'{name}离职证明.docx')
